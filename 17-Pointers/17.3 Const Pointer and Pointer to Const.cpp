...
int main() {
	...
	*p_number1 = 32;
	...
	//Pointer to const
	//Pointer pointing to constant data :  can't modify the data through pointer

    std::cout << "Pointer is modifiable , pointed to value is constant : " << std::endl;
	int number3 {632}; // Although omitting the const on number3 here, and it is still
                             // going to compile, it is advised to be as explicit as possible
                             // and put the const in front.
    ...
    //Although I can't change what's pointed to by p_number3,I can still change where it's pointing
